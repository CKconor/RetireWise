        ...
        <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex cursor-pointer items-center gap-2 rounded-lg bg-gradient-to-br from-[#0c1929] to-[#1e3a5f] px-4 py-2 text-sm font-medium text-white transition-all hover:shadow-lg hover:shadow-[#0c1929]/20 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isGeneratingPdf ? (
                <>
